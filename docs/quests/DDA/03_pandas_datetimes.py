...
Original file is located at
    https://colab.research.google.com/drive/1wOkbEI8pF6XVbZ7Q4bfUUqtPdx3173yN
"""
...
"""#### 문자열이 날짜 구성과 유사 ---> to_datetime()"""

df_datetimes["시작일_datetime"] = pd.to_datetime(df_datetimes["시작일"])
df_datetimes.info()

"""#### 문자열(날짜 구성이 묘할때) -> to_datetime with formtatting datatype
...
pd.to_datetime(df_datetimes["신청일"])

df_datetimes["신청일_datetime"] = pd.to_datetime(df_datetimes["신청일"],format="%Y.%m.%d")
df_datetimes.info()                                                                                   # 시작일 datetime 의 타입이 object에서 datetime으로 바뀜

"""#### 수치형"""

df_datetimes.describe()
...
df_datetimes["착수일 간격"] = df_datetimes["신청일_datetime"] - df_datetimes["시작일_datetime"]

df_datetimes["착수일 간격"]

df_datetimes.describe()

df_datetimes.describe(include = ["datetime"],datetime_is_numeric=True)
