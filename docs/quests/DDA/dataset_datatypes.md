...
|3|Large Lymphocyte|혈액 내 큰 림프구 수치를 나타내는 지표|int|환자의 연령,흡연여부,고혈압여부 등에 따른 혈액내 림프구 수치의 분포를 분석|
|4|Location of herniation|탈출한 디스크의 위치|||
|5|ODI|척추 통증 장애 지수로, 일상 생활에서 발생하는 제한 정도를 평가하는 지표|51., 26., nan, 18., 31., 39., 22., 10., 30., 29., 27., 42., 28., 44., 40., 21., 14., 37., 36., 38., 15., 35., 43., 32., 19., 13., 24., 49., 33., 55., 41., 17., 68., 25., 12., 46., 23., 20., 34., 11., 45., 16., 47.,  9.,  4.||
|6|가족력|질병이나 유전적 소인이 부모나 가족 선조에 보이는 경우|||
|7|간질성폐질환|폐 건강 상태를 나타내는 지표|||
|8|고혈압여부|고혈압 유무를 나타내는 지표|||
|9|과거수술횟수|과거 수술을 받은 횟수를 나타내는 지표|||
|10|당뇨여부|당뇨병 유무를 나타내는 지표|||
|11|말초동맥질환여부|말초 동맥 질환 유무를 나타내는 지표|||
|12|빈혈여부|빈혈 유무를 나타내는 지표|||
|13|성별|남성 또는 여성 성별을 나타내는 지표|||
...
|51|척추이동척도|척추 이동 범위를 나타내는 지표|'Down', 'Up', 'Middle', 'Extremely down', 'Extremely up'||
